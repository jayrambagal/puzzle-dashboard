...
export default function DashboardPage() {
  ...
  // lightweight quick-create flow (uses upload result)
  ...
  const columns = [
    { key: "name", header: "Puzzle Name" },
    { key: "author", header: "Author" },
    {
      key: "publishDate",
      header: "Date of Publish",
      render: (p: IPuzzle) => new Date(p.publishDate).toLocaleDateString(),
    },
    { key: "status", header: "Status" },
    { key: "puzzleType", header: "Puzzle Type" },
    { key: "collectionType", header: "Collection Type" },
    {
      key: "actions",
      header: "Actions",
      render: (p: IPuzzle) => (
          ...
          <section className={theme.section}>
            ...
            <div className={theme.grid2}>
              ...
              <div className={theme.stack12}>
                ...
                >
                  {["Quiz", "Crossword", "Word Search", "Sudoku"].map((t) => (
